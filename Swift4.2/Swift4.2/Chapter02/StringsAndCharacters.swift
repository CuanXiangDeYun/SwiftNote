    ...
    override func viewDidLoad() {
        ...
        */
        ...
        /** 几个属性:
         ...
         index(before:<#T##String.Index#>) : 可以获取到前一个索引
         index(after: <#T##String.Index#>) : 可以获取到最后一个索引
         index(of: <#T##Character#>) : 获取某个字符所在的下标
         index(<#T##i: String.Index##String.Index#>, offsetBy: <#T##Int#>) : 这种方式可以避免多次调用 index(before:) index(after:)
        ...
        **/
        ...
        // 字符串插入和删除
        /**
         insert(<#T##newElement: Character##Character#>, at: <#T##String.Index#>) : 在一个字符串的指定索引插入一个字符
         insert(contentsOf: <#T##Collection#>, at: <#T##String.Index#>): 在一个字符串的指定索引插入一个段字符串
         
         remove(at: <#T##String.Index#>) : 在一个字符串的指定索引删除一个字符
        ...
        **/
        ...
        // 子字符串
        /**
         prefix(<#T##maxLength: Int##Int#>) : 获取由前几个字符组成的字符串
        ...
        **/
        ...
        // 使用注意
        // 当你从字符串中获取一个子字符串 —— 例如，使用下标或者 prefix(_:) 之类的方法 —— 就可以得到一个 SubString 的实例，而非另外一个 String。Swift 里的 SubString 绝大部分函数都跟 String 一样，意味着你可以使用同样的方式去操作 SubString 和 String。然而，跟 String 不同的是，你只有在短时间内需要操作字符串时，才会使用 SubString。
        ...
        // 比较字符串
        // Swift 提供了三种方式来比较文本值：字符串/字符相等、前缀相等和后缀相等。
        ...
        // http://m.swift51.com/swift4.0/chapter2/03_Strings_and_Characters.html
    }
